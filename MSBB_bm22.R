...
setwd(paste0("C:/Users/axv851/Documents/RNA_SEQ"))

rosmap_unnorm <- read.delim(file ="AMP-AD_MSBB_MSSM_BM_22.raw_counts.tsv" )
...
rnaseq_cov <- rnaseq_cov[rnaseq_cov$BrodmannArea == "BM22", ]
...
IDS_df <- IDS_df[IDS_df$sampleIdentifier != "hB_RNA_7995",]
